  ...
  return (
    <>
      ...
      <div style={{display:"flex", justifyContent: "space-around"}}>
          <h3 onClick={() => setActiveComponent(TypeAhead.Mui)} style={{cursor:"pointer"}}>MUI Component</h3>
          <h3 onClick={() => setActiveComponent(TypeAhead.Custom)} style={{cursor:"pointer"}}>Custom Component</h3>
      </div>
